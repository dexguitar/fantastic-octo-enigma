...
const config = {
    ...
    topics: {
        imageProcessing: process.env.TOPIC_IMAGE_PROCESSING || 'document-image-processing',
        textProcessing: process.env.TOPIC_TEXT_PROCESSING || 'document-text-processing',
        processingResults: process.env.TOPIC_PROCESSING_RESULTS || 'document-processing-results',
    },
